    ...
    <div v-if="state.heldByAuthority === true">
      ...
      <div v-if="state.docTypeChoice === documentType.Memoranda">
        <label>
          ...
          <h4>Is it records of Riksdag committees, auditors of local authorities, government-appointed commission of
            inquiry or local authorities that are related to a matter dealt with solely in order to prepare the matter
            for decision?</h4>
        ...
        <label v-if="state.riskdagRecord === false">
          <hr />
          <h4>Has the document been finally checked and approved by authority or has otherwise received final form?</h4>
      ...
      <div v-if="state.docTypeChoice === documentType.Other">
        ...
        <div v-if="state.dispatched === false">
          ...
          <label v-if="state.specificMatter === true">
            <hr />
          ...
          <label v-else-if="state.specificMatter === false">
            <hr />
            <h4>Has the document been finally checked and approved by the authority or has it otherwise received final
              form?</h4>
            (I) Ch 2, art 10, ph 1 FPA
